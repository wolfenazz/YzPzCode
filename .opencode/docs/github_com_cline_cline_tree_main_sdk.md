# cline/sdk at main · cline/cline · GitHub

> Source: https://github.com/cline/cline/tree/main/sdk
> Cached: 2026-08-13T09:54:32.198Z

---

[](https://private-user-images.githubusercontent.com/7799382/582368686-a05da977-2cb7-498a-88ca-20f24c9562e1.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..qOjkZCTK-KhDN08xHw-8scX2bP9Cp1k3tv8GrxVn1lc)
...
Explore full working examples in [`examples/`](/cline/cline/blob/main/sdk/examples) and app examples in [`apps/examples/`](/cline/cline/blob/main/sdk/apps/examples):

Example
Description

[Plugins](/cline/cline/blob/main/sdk/examples/plugins)
Custom tools with workspace-aware context, lifecycle hooks, and branch-level safety policies

[Subagent Orchestration](/cline/cline/blob/main/sdk/examples/plugins/agents-squad)
Spawn and manage background agents with presets, skills, and cross-agent handoffs

[Hooks](/cline/cline/blob/main/sdk/examples/hooks)
File-based and runtime hooks for logging, review gates, context injection, and lifecycle automation

[Cron Automations](/cline/cline/blob/main/sdk/examples/cron)
Recurring and event-driven automation specs for scheduled quality checks and PR workflows

[Desktop App](/cline/cline/blob/main/sdk/apps/examples/desktop-app)
Tauri desktop shell with a Bun sidecar backend and Next.js UI

[VS Code Extension App](/cline/cline/blob/main/sdk/apps/examples/vscode)
VS Code extension example that runs Cline sessions over the RPC runtime
...
For Telegram-specific connector behavior, see [`apps/cli/src/connectors/adapters/telegram.md`](/cline/cline/blob/main/sdk/apps/cli/src/connectors/adapters/telegram.md).
...
[](#contributing)
To contribute to the project, start with our [Contributing Guide](/cline/cline/blob/main/sdk/CONTRIBUTING.md) to learn the basics. You can also join our [Discord](https://discord.gg/cline) to chat with other contributors in the `#contributors` channel. If you're looking for full-time work, check out our open positions on our [careers page](https://cline.bot/join-us)!

## License

[](#license)
[Apache 2.0 © 2026 Cline Bot Inc.](/cline/cline/blob/main/sdk/LICENSE)