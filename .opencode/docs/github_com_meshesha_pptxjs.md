# GitHub - meshesha/PPTXjs: jquery plugin for convertation pptx to html · GitHub

> Source: https://github.com/meshesha/pptxjs
> Cached: 2026-08-13T01:32:07.531Z
...
[](#pptxjs)
[](/meshesha/PPTXjs/blob/master/LICENSE)

### jQuery plugin for convertation pptx to html using pure javascript.

[](#jquery-plugin-for-convertation-pptx-to-html-using-pure-javascript)
### Demo: [https://pptx.js.org/pages/demos.html](https://pptx.js.org/pages/demos.html)

[](#demo-httpspptxjsorgpagesdemoshtml)
# environment
...
- support 'revealjs'([https://revealjs.com](https://revealjs.com)) (It is not recommended to add a theme because it distorts some of the elements like tables )

- I think i fix issue [officetohtml/issues/7](https://github.com/meshesha/officetohtml/issues/7) (not tested)

- Change loading view

- Fix center slides in fullscreen mode - ([https://github.com/meshesha/divs2slides](https://github.com/meshesha/divs2slides) v1.3.3)
