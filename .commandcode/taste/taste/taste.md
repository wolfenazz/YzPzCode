...
- Values time-saving batching patterns: prefers letting users queue multiple similar operations (e.g., numbered instruction slots for several element edits) and send them all in one shot, instead of performing them one-by-one. Confidence: 0.7
